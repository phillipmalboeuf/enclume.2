  ...
  return <>
    ...
    <main className={`${current_category ? ({
      ...
      <div className='padded padded--big_top'>
        <div className='grid grid--guttered' style={{ alignItems: 'flex-start' }}>
          <div className='col col--2of12 col--tablet_landscape--3of12 col--tablet_portrait--12of12' style={{ position: 'sticky', top: '5rem' }}>
            <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <Link className={`header__link${!search.category ? ' active' : ''}`} href='/projets'>Tous</Link>
              {about.fields.categories.map((category: any) =>
                <Link key={category.fields.title} className={`header__link${search.category === category.fields.key ? ' active' : ''}`} href={`/projets?category=${category.fields.key}`}>
          ...
          <div className='col col--10of12 col--tablet_landscape--9of12 col--tablet_portrait--12of12'>
            <div className='grid grid--guttered'>
              ...
              }).map(project => <div key={project.fields.url} className='col col--6of12 col--tablet_landscape--6of12 col--tablet_portrait--12of12'>
